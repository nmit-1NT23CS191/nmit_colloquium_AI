  ...
  return (
    <aside className="w-60 h-screen bg-card border-r border-border-main flex flex-col py-3 shrink-0 transition-colors">
      <div className="flex items-center gap-2.5 px-5 py-4 mb-2">
        ...
        <div>
          <p className="text-sm font-bold text-text-main leading-none">{t('nmit_colloquium')}</p>
          <p className="text-[10px] text-indigo-500 font-semibold mt-0.5">{t('admin_portal')}</p>
        </div>
      </div>
